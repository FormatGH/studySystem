<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:110:"D:\PHPstudy\PHPTutorial\WWW\studySystem\tp5.0\public/../application/studysystem\view\index\lookTCourseFile.php";i:1524819784;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!--                    <a href="/static/studySystem/upload/<?php echo $tid; ?>/<?php echo $coursename; ?>(<?php echo $academy; ?>)/第<?php echo $i; ?>章-<?php echo $cname; ?>/<?php echo $i; ?>-<?php echo $j; ?><?php echo $sname; ?>/test.pdf">-->
                    <br>
                    <a href="/static/studySystem/upload/<?php echo $tid; ?>/<?php echo $coursename; ?>(<?php echo $academy; ?>)/第<?php echo $i; ?>章-<?php echo $cname; ?>/<?php echo $i; ?>-<?php echo $j; ?><?php echo $sname; ?>/a.docx"  target="_blank">
                        &nbsp;&nbsp;
