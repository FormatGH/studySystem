<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"E:\phpStudy\PHPTutorial\WWW\tp5.0\public/../application/studysystem\view\index\lookUserAcademy.php";i:1521462322;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="dark-matter" align="" style="">
    ...
    <center>
        ...
        <div id="look" align="center" style="align-self:center;width:400pt;height:200pt;border: 2pt solid ;font-size:14pt;font-family: 楷体; font-weight: 600;text-align: center;align-content: center">
            <form name="toedit" action="/studySystem/editUserAcademy" method="post">
                <label>
                    <br>
                    <br>
                    <table align="center" >
