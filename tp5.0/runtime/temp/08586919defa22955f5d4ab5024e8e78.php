<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"E:\phpStudy\PHPTutorial\WWW\tp5.0\public/../application/studysystem\view\index\lookBasicData.php";i:1521546910;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<script>
    ...
    function look(x) {
        ...
        var tophint=document.getElementById('tophint');
        if(x=="realname"){
            a.value="<?php echo $realname; ?>";
        }else if(x=="email"){
            a.value="<?php echo $email; ?>";
        }else if(x=="message"){
            a.value="<?php echo $message; ?>";
        }
...
<div class="dark-matter">
    ...
    <div style="width:800pt;height:350pt;border: 2pt solid ">
        ...
        <div class="up-img-cover"  id="up-img-touch" >
            ...
            <img class="am-circle" alt="点击图片上传" src="<?php echo $imagename; ?>" style="align-self: center" data-am-popover="{content: '点击上传', trigger: 'hover focus'}" >
        </div>
                    ...
                    <tr>
                        <td width="800" height="30" align="center" style="align-content: center">
                            <form action="/studySystem/updateRealname" method="post" id="realname_form" name="realname_form" >
                                ...
                                <input type="text"  id="realname" name="realname"   readonly="readonly" value="<?php echo $realname; ?>" style="width=400pt;background-color: #555;color: yellow" ondblclick="edit('realname')">
                                <input type="text"  id="saverealname" hidden="hidden" value="保存"  readonly="readonly" style="width:35pt;background-color:green;color: black" onclick="save('realname','<?php echo $realname; ?>')">
                    ...
                    <tr>
                        <td width="800" height="30" align="center" style="align-content: center">
                            <form action="/studySystem/updateEmail" method="post" id="email_form" name="email_form">
                                ...
                                <input type="text"  id="email" name="email"  readonly="readonly" value="<?php echo $email; ?>" style="width=400pt;background-color: #555;color: yellow" ondblclick="edit('email')">
                                <input type="text"  id="saveemail" hidden="hidden" value="保存"  readonly="readonly" style="width:35pt;background-color:green;color: black" onclick="save('email','<?php echo $email; ?>')">
                    ...
                    <tr>
                        <td width="800" height="30" align="center" style="align-content: center">
                            <form action="/studySystem/updateMessage" method="post" id="message_form" name="message_form">
                                ...
                                <textarea id="message" name="message"  style="width:180pt;;background-color: #555;color: yellow" ondblclick="edit('message')"><?php echo $message; ?></textarea>
<!--                                <input type="text"  id="message" name="message"  style="width:180pt;;background-color: #555;color: yellow" value="<?php echo $message; ?>" ondblclick="edit('message')">-->
                                <input type="text"  id="savemessage" hidden="hidden" value="保存"  readonly="readonly" style="width:35pt;background-color:green;color: black" onclick="save('message','<?php echo $message; ?>')">
	...
	<div class="am-modal-bd  up-frame-body">
	  ...
	  <div class="am-g am-fl">
		<div class="up-control-btns">
			...
			<span class="am-icon-check" id="up-btn-ok" url="http://localhost/studySystem/uploadUserPhoto?uid=<?php echo $uid; ?>"></span>
		</div>
	  </div>
